...
import ContactLensServices from "services/contactlensServices";
import PageTitle from "components/Typography/PageTitle";
import { SidebarContext } from "context/SidebarContext";
import ContactLensTable from "components/contactlens/ContactLensTable";
...
const ContactLens = () => {
    ...
    // console.log(setCategory,'c')

    const { data, loading } = useAsync(() =>
        ContactLensServices.getAllContactLenses({
            page: currentPage,
            limit: limitData,
            category: category,
            title: searchText,
    ...
    // console.log("contactLens", data.lenses);
    ...
    } = useProductFilter(data?.lenses);

    return (
        <>
            <PageTitle>{t("Contact-LensPage")}</PageTitle>
            <DeleteModal ids={allId} setIsCheck={setIsCheck} title={title} />
            <BulkActionDrawer ids={allId} title="ContactLens" />
            <MainDrawer>
                  ...
                  {t("PublishedTbl")}
                    ...
                    <TableFooter>
                        <Pagination
                            ...
                            label="ContactLens Page Navigation"
                        />
                    </TableFooter>
                </TableContainer>
            ) : (
                <NotFound title="ContactLens" />
            )}
        </>
    );
};
