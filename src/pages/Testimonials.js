...
import TestimonialTable from "components/testimonials/TestimonialsTable";
...
const Store = () => {
    ...
    const { data, loading } = useAsync(() => TestimonialServices.getAllTestimonials({ Name: adminInfo.name }));
    ...
    return (
        <>
            <PageTitle>{t("Testimonials")} </PageTitle>
            <MainDrawer>
                <StaffDrawer />
            </MainDrawer>
            ...
            {loading ? (
                ...
                <TableContainer className="mb-8 rounded-b-lg">
                    <Table>
                        ...
                        <TestimonialTable staffs={dataTable} lang={lang} />
                    </Table>
                    <TableFooter>
                        <Pagination
